            ...
            {isChatOpen && (
                <div className="chat-container fixed bottom-3 right-3 w-[300px] h-[400px] bg-white shadow-lg rounded-lg flex flex-col">
                    <div className="chat-header bg-red-500 text-white px-4 py-2 rounded-t-lg flex items-center justify-between">
                        ...
                        <div
                            onClick={toggleChat}
                            className="text-white text-lg bg-transparent hover:bg-red-600 rounded-full w-[20px] h-[20px] flex items-center justify-center rounded-full cursor-pointer transition-all duration-200"
                        >
                            &times;
                        </div>
                    </div>
                    ...
                    <div className="chat-input m-2 p-1 border-t flex items-center border rounded-full text-sm">
                        ...
                        <Button
                            onClick={sendMessage}
                            className="flex items-center gap-1 cursor-pointer bg-red-500 text-white w-[80px] h-full rounded-full outline-none hover:bg-red-600 text-[14px]"
                        >
                            Gửi <Send />
                        </Button>
                    </div>
