...
export default function Home() {
    ...
    const handleModalOpen = (content: 'Cart' | 'View') => {
                    ...
                    <div className="header_featured_products">
                        ...
                        <div className="featured_products_list grid grid-cols-4 gap-5 mt-[50px]">
                            {products.map((product) => (
                                <div className="featured_products_item group rounded border overflow-hidden">
                                    {/* Img item */}
                                    <div className="featured_products_img relative w-full h-[200px] overflow-hidden mb-4">
