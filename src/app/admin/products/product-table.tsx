...
import { ProductListResponseType } from '@/schemaValidations/product.schema';
import { AddProduct } from './add-products';
import EditProduct from './edit-product';
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle } from '@/components/ui/alert-dialog';
import { toast, Toaster } from 'sonner';

const ProductActionsDropdown = ({ product }: { product: ProductsItem }) => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-48 shadow-md rounded-lg bg-gray-700 border">
        <DropdownMenuItem onClick={copyProductName} className="hover:bg-gray-100 transition duration-200 p-2 rounded-md cursor-pointer">
          Sao chép Tên
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem
            ...
            className="hover:bg-blue-100 text-blue-600 transition duration-200 p-2 rounded-md cursor-pointer"
            >
            Sửa Sản Phẩm
            </DropdownMenuItem>
...
type ProductsItem = ProductListResponseType['product'][0];
...
export const columns: ColumnDef<ProductsItem>[] = [
    ...
    },
    {
        ...
        enableHiding: false,
        cell: ({ row }) => {
            const product = row.original as ProductsItem;
